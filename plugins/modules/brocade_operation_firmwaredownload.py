...
module: brocade_operation_firmwaredownload
short_description: Brocade Fibre Channel operation firmwaredownload
version_added: '2.7'
...
def main():
    ...
    firmwaredownload = input_params['firmwaredownload']
    result = {"changed": False}

    operation_helper(module, fos_ip_addr, fos_user_name, fos_password, https, ssh_hostkeymust, throttle, vfid, "firmwaredownload", "firmwaredownload_parameters", firmwaredownload, result, timeout)
