...
short_description: Brocade Fibre Channel loggig audit configuration
version_added: '2.7'
...
def main():
    ...
    singleton_helper(module, fos_ip_addr, fos_user_name, fos_password, https, True, throttle, vfid, "brocade_logging", "audit", audit, result, timeout)
