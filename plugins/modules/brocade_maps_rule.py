...
module: brocade_maps_rule
short_description: Brocade Fibre Channel MAPS rule configuration
version_added: '2.7'
...
options:
    ...
    rules:
        description:
        - list of rules to be updated. All writable attributes supported
...
def main():
    ...
    rules = input_params['rules']
    result = {"changed": False}

    list_helper(module, fos_ip_addr, fos_user_name, fos_password, https, True, throttle, vfid, "brocade_maps", "rule", rules, True, result, timeout)
